...
object Day8 with
  @tailrec private def countEscaping(acc: Int = 0, str: String): Int = 
    ...
    else if (str.startsWith("\\")) countEscaping(acc + 1, str.substring(2))
    else countEscaping(acc + 1, str.substring(1))

  @tailrec private def countUnescaping(acc: Int = 2, str: String): Int = 
    if (str.isEmpty) acc
    else if (str.startsWith("\\\"")) countUnescaping(acc + 4, str.substring(2))
    else if (str.startsWith("\"")) countUnescaping(acc + 2, str.substring(1))
    else if (str.startsWith("\\")) countUnescaping(acc + 2, str.substring(1))
    else countUnescaping(acc + 1, str.substring(1))
