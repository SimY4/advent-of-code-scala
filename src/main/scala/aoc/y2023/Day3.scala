...
object Day3:
  ...
  def solve(input: String): Long =
    val syms = symbols(input)

    def isPart(c: Coord, sym: String): Boolean =
      (for
        y <- c.y - 1 to c.y + 1
        x <- c.x - 1 to c.x + sym.length()
        if syms.get(Coord(x, y)).exists(_.isLeft)
      yield ()).nonEmpty

    syms.view
      .collect:
        case (coord, Right(sym)) if isPart(coord, sym) => sym.toLong
      .sum

  def solve2(input: String): Long =
    val syms = symbols(input)

    def parts(c: Coord): List[Long] =
      (for
        y <- c.y - 1 to c.y + 1
        x <- c.x - 3 to c.x + 1
        case Right(d) <- syms.get(Coord(x, y))
        if x >= c.x || x + d.length() >= c.x
      yield d.toLong).toList

    syms.view
      .collect:
        case (coord, Left("*")) => parts(coord)
      .collect:
        case f :: s :: Nil => f * s
      .sum
  ...
  val input =
    """....................................18..........889.270.....748.280...997.................617..............622........763............476....
      ...
      |.............885.................................600.456...........................................679.............16.........392.....841...""".stripMargin
