...
object Day8:
  private val linePattern = "(\\w+) (inc|dec) (-?\\d+) if (\\w+) (<|<=|==|!=|>=|>) (-?\\d+)".r
  ...
  private enum Condition:
    ...
    case Gt(register: String, n: Int)
    case Ge(register: String, n: Int)
    case Lt(register: String, n: Int)
    case Le(register: String, n: Int)
    case Eq(register: String, n: Int)
    case Ne(register: String, n: Int)
  import Condition.*
  ...
  private def parseLine(line: String): Instruction =
    line match
      case linePattern(r, "inc", n1, r1, "<", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Lt(r1, n2.toInt))
      case linePattern(r, "inc", n1, r1, "<=", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Le(r1, n2.toInt))
      case linePattern(r, "inc", n1, r1, ">", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Gt(r1, n2.toInt))
      case linePattern(r, "inc", n1, r1, ">=", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Ge(r1, n2.toInt))
      case linePattern(r, "inc", n1, r1, "==", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Eq(r1, n2.toInt))
      case linePattern(r, "inc", n1, r1, "!=", n2) =>
        Instruction(r, Command.Inc(n1.toInt), Condition.Ne(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, "<", n2) =>
        Instruction(r, Command.Dec(n1.toInt), Condition.Lt(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, "<=", n2) =>
        Instruction(r, Command.Dec(n1.toInt), Condition.Le(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, ">", n2) =>
        Instruction(r, Command.Dec(n1.toInt), Condition.Gt(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, ">=", n2) =>
        Instruction(r, Command.Dec(n1.toInt), Condition.Ge(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, "==", n2) =>
        Instruction(r, Command.Dec(n1.toInt), Condition.Eq(r1, n2.toInt))
      case linePattern(r, "dec", n1, r1, "!=", n2) =>
  ...
  private def eval(instructions: Seq[Instruction]): Map[String, CurrentAndMax] =
    def evalCondition(registers: Map[String, CurrentAndMax], condition: Condition): Boolean =
      ...
      condition match
        ...
        case Ge(_, n) => registerVal >= n
        case Lt(_, n) => registerVal < n
        case Le(_, n) => registerVal <= n
  ...
  val input = """q inc -541 if c != 4
                ...
                |px dec -442 if j <= 7300""".stripMargin
